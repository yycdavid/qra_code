python2 main.py --run_dir result/ --cuda --model attention --freeze_embedding --train data/askubuntu/train --eval data/android/ --d 300 --embedding word_vectors/glove.npz --max_epoch 50 --use_content --eval_use_content --criterion cosine
